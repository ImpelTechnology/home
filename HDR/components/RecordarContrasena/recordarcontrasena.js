...
function Recordar() {
    try {
        ...
        if (email == ""){
            alert("Debes llenar el campo 'email' para procesar la solicitud");
            return;
        }
        var inforecordar = [{
            email: email
                            ...
                            $.each(data, function (index, item) {
                                if (item.email == email) {
                                    ...
                                    $.ajax({
                                        ...
                                        dataType: "json",
                                        success: function (data) {
                                            alert("Se envió la solicitud de cambio de contraseña... Revisa tu email!");
                                        },
                                        error: function (err) {
